...
export const StoreHome: React.FC = () => {
  ...
  const { data: featuredProducts = [], isLoading: loadingProducts } = useGetStoreProductsQuery({ featured: true });
        ...
        <section className="space-y-5">
          <div className="flex items-end justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-blue-100 mt-1">Selección destacada de la tienda</p>
            </div>
            <Link to="/products?featured=true" className="text-sm text-white/90 hover:text-white transition-colors">
